...
export class TarifsComponent implements OnInit {
  ...
  labels:any[]=[{lab:'km',dim:0.1},{lab:'mf',dim:0.5},{lab:'mnf',dim:0.5},{lab:'mnt',dim:0.5},{lab:'off',dim:0.5},{lab:'spo',di:0.5},{lab:'std',dim:0.5},{lab:'ofs',dim:0.5},{lab:'sps',dim:0.5},{lab:'sts',dim:0.5},{lab:'spv',dim:0.5}]
